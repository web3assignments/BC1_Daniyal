...
/// @title Secure payment contract
/// @author Daniyal Hussain
/// @notice You can use this contract the have a safe third party verification
...
contract SecurePayment {
  ...
  /// @author Daniyal Hussain
  /// @notice Create a secure payment transaction
  /// @dev Adds the transaction to the mapping
  /// @param _personA The wallet address of the first person
  /// @param _personB TThe wallet address of the second person
  /// @param _middleMan The wallet address of the middleMan person
  /// @param _amount transaction amount
  /// @param _description description of the secure payment
  ...
  /// @author Daniyal Hussain
  /// @notice Checks the wallet in
  /// @dev Get the wallet address from msg.sender
  /// @param transactionId The id of the transaction
  /// @return Bool if it works or not
 function checkIn(uint transactionId) public returns (bool) {    
  ...
  /// @author Daniyal Hussain
  /// @notice Pays out
  /// @dev Only if all concenses are in 
  /// @param transactionId The id of the transaction
  /// @return Bool if it works or not
  ...
  /// @author Daniyal Hussain
  /// @notice Gets the status of the payment
  /// @dev returns view
  /// @param transactionId The id of the transaction
  /// @return Bool if its payed out
